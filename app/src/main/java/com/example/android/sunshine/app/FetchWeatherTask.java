...
*/
    ...
    private String formatHighLows(double high, double low) {
        ...
        // Check preference should it be in celsius or fahrenheit
        String unitPref = updateUnits();
        if (unitPref.equals(mContext.getString(R.string.pref_units_imperial))) {

            high = (high*1.8)+32;
            low = (low*1.8)+32;
        }
        else if (!unitPref.equals(mContext.getString(R.string.pref_units_metric)))
            Log.d(LOG_TAG,"Unit type not found"+unitPref);
    ...
    private String updateUnits() {
        ...
        String syncConnPref = sharedPref.getString(mContext.getString(R.string.pref_units_key), mContext.getString(R.string.pref_units_metric));
